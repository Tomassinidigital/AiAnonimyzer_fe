...
/**
 * Contenuto della singola pagina PDF riletto dal server (modale di
 * offuscamento). Offset assoluti nel documento: `text` inizia a `char_start`,
 * `entities` e `blocks` usano gli stessi offset delle correzioni manuali.
 */
